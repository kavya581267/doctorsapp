                    ...
                    <View>
                        ...
                        <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 20, marginBottom: 10,backgroundColor:COLORS.white }}>
...

                            {
                                ...
                                <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => navigation.navigate("CreatePatientMedication", { appointment: appointment, facesheet: faceSheetData, patient:patient })}>
                                    <Text style={{ color: COLORS.primary, fontWeight: "500" }}> <Feather name="edit" size={15} color={COLORS.primary} /> Edit</Text>
                                </TouchableOpacity>
                            }
